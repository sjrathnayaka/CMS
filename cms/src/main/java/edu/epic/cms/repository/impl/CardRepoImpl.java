...
public class CardRepoImpl implements CardRepo {
    ...
    public Card save(Card card) {
        ...
        String sql = "INSERT INTO Card (CardNumber, ExpiryDate, CreditLimit, CashLimit, " +
                     "CardStatus, AvailableCreditLimit, AvailableCashLimit, LastUpdateTime) " +
                     "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        jdbcTemplate.update(sql, 
            ...
            card.getAvailableCreditLimit() != null ? 
                            card.getAvailableCreditLimit() : card.getCreditLimit(),
            card.getAvailableCashLimit() != null ? 
                            card.getAvailableCashLimit() : card.getCashLimit(),
    ...
    public int update(Card card) {
        String sql = "UPDATE Card SET ExpiryDate = ?, CreditLimit = ?, " +
                     ...
                     "AvailableCashLimit = ?, LastUpdateTime = ? WHERE CardNumber = ?";
