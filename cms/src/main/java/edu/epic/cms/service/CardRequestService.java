...
public interface CardRequestService {
     ...
     * Validates that creditLimit >= availableCreditLimit before allowing deactivation.
     * 
     ...
     * @throws edu.epic.cms.exception.RequestNotFoundException if request not found
     * @throws edu.epic.cms.exception.InvalidRequestStatusException if request is not pending
     */
    CardRequest approveRequest(Long requestId, String remark);
     ...
     * @throws edu.epic.cms.exception.InvalidRequestStatusException if request is not pending
     */
    CardRequest rejectRequest(Long requestId, String remark);
}
